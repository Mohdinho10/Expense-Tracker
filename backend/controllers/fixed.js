...
export const getDashboardData = asyncHandler(async (req, res) => {
  ...
  // Fetch last 5 income and expense transactions and label them
  ...
  const lastTransactions = [
    ...lastIncome.map((transaction) => ({
      ...transaction.toObject(),
      type: "income",
    })),
    ...lastExpense.map((transaction) => ({
      ...transaction.toObject(),
      type: "expense",
    })),
  ].sort((a, b) => b.date - a.date); // Sort all combined by date
